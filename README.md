...
extension ViewController {
    ...
    private func createGridSection(containerWidth: CGFloat, traitCollection: UITraitCollection) -> NSCollectionLayoutSection {
        ...
        // Calculate grid cell height if needed
        ...
        // SOLUTION: Use the new API for horizontal groups with repeating items
        let groupSize = NSCollectionLayoutSize(
            widthDimension: .fractionalWidth(1.0),
            heightDimension: .absolute(finalHeight)
        )
        
        // Modern API: repeatingSubitem instead of deprecated subitem:count:
        let group = NSCollectionLayoutGroup.horizontal(
    ...
    private func calculateMaxGridCellHeight(for cellWidth: CGFloat) -> CGFloat {
        ...
        // Create a temporary sizing cell
